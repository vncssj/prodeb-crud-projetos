 ...
 * @property \App\Model\Table\TasksTable&\Cake\ORM\Association\BelongsTo $PredecessorTasks
 *
...
class TasksTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsTo('PredecessorTasks', [
    ...
    public function validationDefault(Validator $validator): Validator
    {
        ...
        $validator
            ->integer('predecessor_task_id')
            ->allowEmptyString('predecessor_task_id');
